...
class ReportingDeveloperFormProcedures:
    ...
    def pending_review_form_procedure(self, item_id, approval, comment, reviewer):
        """
        ...
        :return: none
        """
        self.helper.add_request_review(item_id, approval, comment, reviewer)
    ...
    def business_review_form_procedure(self, item_id, approval,
        ...
        self.helper.add_business_review(item_id, approval, reviewer, comment)
...
class ReportingDeveloperHelperFunctions:
    ...
    def add_request_review(self, item_id, approval, comment, reviewer=None):
        """
        :param item_id: fk int item id
        :param approval: int 0 or 1 for approval
        :param comment: text for comment
